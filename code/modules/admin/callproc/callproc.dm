...
/client/proc/callproc_blocking(list/get_retval)
	...
	BLACKBOX_LOG_ADMIN_VERB("Advanced ProcCall") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	if(get_retval)
...
/client/proc/callproc_datum(datum/A as null|area|mob|obj|turf)
	...
	BLACKBOX_LOG_ADMIN_VERB("Atom ProcCall") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
