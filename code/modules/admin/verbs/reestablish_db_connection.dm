/client/proc/reestablish_db_connection()
	...
	if (SSdbcore.IsConnected())
		...
		BLACKBOX_LOG_ADMIN_VERB("Force Reestablished Database Connection") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	...
	BLACKBOX_LOG_ADMIN_VERB("Reestablished Database Connection") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
