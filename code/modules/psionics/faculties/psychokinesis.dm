...
/decl/psionic_power/psychokinesis
	...
	use_manifest = TRUE
	use_sound = null
	abstract_check = /decl/psionic_power/psychokinesis
...
/decl/psionic_power/psychokinesis/tinker
	...
	use_description = "Click on or otherwise activate an empty hand while on help intent to manifest a psychokinetic tool."
	admin_log = FALSE
