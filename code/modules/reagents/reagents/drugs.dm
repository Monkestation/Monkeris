...
/datum/reagent/drug/music/assaultandpepper
	name = "Assault and Pepper"
	id = "assaultandpepper"
	music_file = 'sound/music/drug/assaultandpepper.ogg'

/datum/reagent/drug/music/internetaccess
...
/datum/reagent/drug/music/wesmokincrack
	name = "We Smokin Crack"
	id = "wesmokincrack"
	music_file = 'sound/music/drug/wesmokincrackogg.ogg'

/datum/reagent/drug/music/on_mob_add(mob/living/L)
	. = ..()
...
/datum/reagent/drug/music/on_mob_delete(mob/living/L)
	..()
	if(music_token)
